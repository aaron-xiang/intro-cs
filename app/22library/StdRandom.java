 ...
 *  including uniform, Bernoulli, geometric, Gaussian2, exponential, Pareto,
...
public final class StdRandom {
    ...
    /**
     * Returns a random real number from a standard Gaussian2 distribution.
     * 
     * @return a random real number from a standard Gaussian2 distribution
    ...
    /**
     * Returns a random real number from a Gaussian2 distribution with mean &mu;
     * and standard deviation &sigma;.
     * 
     * @param  mu the mean
     * @param  sigma the standard deviation
     * @return a real number distributed according to the Gaussian2 distribution
